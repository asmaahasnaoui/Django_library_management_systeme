# Generated by Django 3.2.6 on 2021-08-11 16:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('available', 'available'), ('retal', 'rental'), ('sold', 'sold')], max_length=50, null=True)),
